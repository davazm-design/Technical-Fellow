...
- `Dockerfile` multi-stage, non-root, imagen mínima (ver `templates/Dockerfile.template`). El server
  DEBE bindear `0.0.0.0` y correr JS compilado (no `tsx` en runtime). Ver `blind_spots.md` BS-7.
- `.dockerignore`.
